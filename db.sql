...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mussi` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
/*Data for the table `autologin` */

insert  into `autologin`(`user`,`series`,`key`,`created`) values (1,'3f8378287542bbbcdc6bdf1ce442c97e9d338c38e4489998524efd079e16162f','08a00b4543e85388b1846111767e8a84ede1f12fdef131fb66d8db8d1063f9ed',1485461323),(1,'d8ad1a0b5fc4088229c4626eaa15d3f2150a0f3a3832cb085a9249a385b15916','f301d7a4a8e30351da196236a099f076e124fe88990a2f1ffc1343f71a38dfca',1485531955);
...
insert  into `categories`(`categories_id`,`name`) values (1,'articulos'),(2,'conversaciones'),(3,'propuestas'),(6,'actividades'),(7,'PBA');
...
/*Data for the table `categories_notes` */

insert  into `categories_notes`(`categoires_notes_id`,`note_id`,`category_id`) values (1,4,2),(2,4,6),(3,5,2),(4,5,6);
...
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=latin1 COMMENT='latin1_swedish_ci';

/*Data for the table `categories_posts` */

insert  into `categories_posts`(`categories_posts_id`,`category_id`,`post_id`) values (20,2,67),(21,3,67),(22,7,67),(57,2,5),(70,2,76),(71,6,76),(72,2,79),(73,2,77),(74,6,77),(75,2,75),(76,2,80),(77,2,73),(78,7,73),(91,7,87),(92,2,88),(93,2,85),(94,7,85),(95,2,86),(96,6,86),(97,2,78);
...
/*Data for the table `social_nets` */

insert  into `social_nets`(`social_nets_id`,`name`,`followers`) values (1,'Twitter',128874),(2,'Facebook',142121),(3,'Instagram',401);
...
insert  into `users`(`id`,`username`,`password`,`profile`,`nombre`,`apellido`,`imagen`) values (1,'mussi','32a4585b8e95929021ae548f5eea18b5',1,'','','mussi.jpg');
